...
class GUI:
	...
	def __init__(self):
		...
		for i in range(0,3):
			...
			for j in range(0,3):
				...
				if not (i == 0 and j == 0):
					self.labels[i][j] = Button(self.boardFrame,text=str(i*3+j),font=('Times 26 bold'),height = 5 , width = 18,bg='#A66300',fg='white')
		...
		self.ButtonsFrame = Frame(self.BottomFrame,bg = "black")
	...
	def start(self):
		...
		self.nextButton = Button(self.ButtonsFrame,bg='white',fg='#444488',text=' Next >>',font=('Algerian 18 bold'),command =lambda:self.nextButtonAction())
		self.previousButton = Button(self.ButtonsFrame,bg='white',fg='#444488',text='<< Previous ',font=('Algerian 18 bold'),state=DISABLED,command =lambda:self.previousButtonAction())
		self.endButton = Button(self.ButtonsFrame,bg='white',fg='#444488',text=' END ',font=('Algerian 18 bold'),command =lambda:self.endButtonAction())
		self.beginButton = Button(self.ButtonsFrame,bg='white',fg='#444488',text=' BEGINNING ',font=('Algerian 18 bold'),command =lambda:self.beginButtonAction())
